...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => ['role:akademik']], function () {
        Route::get('/dashboard/akademik', 'SidangRegController@index')->name('akademik.mahasiswa');
        Route::post('/dashboard/akademik/{id}', 'SidangRegController@ajukan')->name('akademik.ajukan');
    });
